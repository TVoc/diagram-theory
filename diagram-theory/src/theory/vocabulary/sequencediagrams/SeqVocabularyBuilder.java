...
public class SeqVocabularyBuilder
{
	...
	public String build(SeqDiagramStore store)
	{
		...
		return OutputConvenienceFunctions.insertTabsNewLine("LTCvocabulary V {", this.getTabLevel())
				...
				+ OutputConvenienceFunctions.insertTabsNewLine("type SDPoint constructed from { " + sdPoints.toString() + " }", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsNewLine("partial NextSD(SDPoint) : SDPoint", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsBlankLine(this.getTabLevel() + 1)
...
//				+ OutputConvenienceFunctions.insertTabsNewLine("type SDPointString constructed from { " + sdPoints.toString() + " }", this.getTabLevel())
				...
				+ OutputConvenienceFunctions.insertTabsNewLine("C_CurrentStackLevel(Time,StackLevel)", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsBlankLine(this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsNewLine("ReturnPoint(Time,StackLevel,SDPoint)", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsNewLine("I_ReturnPoint(StackLevel,SDPoint)", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsNewLine("C_ReturnPoint(Time,StackLevel,SDPoint)", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsNewLine("Cn_ReturnPoint(Time,StackLevel,SDPoint)", this.getTabLevel() + 1)
				+ OutputConvenienceFunctions.insertTabsBlankLine(this.getTabLevel() + 1)
